...
<div class="conteiner">
	...
	<? } ?>
		...
		<div class="content_prices_description">
			<p>В данном разделе представлена информация о ценах на пластиковые окна в <?=$this->city->gorode?> на <?=date('Y')?> год. В списке представлены компании <?=$this->city->goroda?>, которые в открытом доступе публикуют стоимость своей продукции. Фирмы отсортированы согласно их рейтингу на сайте OKNAORG.RU.</p>
			<p>В столбце "цена" указана минимальная стоимость одного окна. Для расчета полной стоимости установки окон воспользуйтесь калькулятором, расположенным на сайтах представленных компаний. Для получения более точной и детальной информации свяжитесь со специалистами фирм по указанным телефонным номерам.</p>
			<p>Полный перечень компаний представлен в разделе <a href="/<?=$this->city->simbol_name?>/company/list">Производители пластиковых окон в <?=$this->city->gorode?></a>.</p>
		</div>
	</div>
</div>
