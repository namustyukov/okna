...
<div class="conteiner">
	...
	<? if (count($companies)) { ?>
		...
		<div class="content_promo_description">
			<p>Информация о скидках и акциях на пластиковые окна собрана от <?=$companies_count?> компаний <?=$this->city->goroda?> и ежеквартально обновляется. В указанном перечне фирмы отсортированы согласно их рейтингу на сайте OKNAORG.RU.</p>
			<p>В краткой форме представлены проходящие рекламные акции и распродажи с указанием сроков проведения. Так же ведется обзор купонных скидок, которые вы можете активировать на сайтах компаний <?=$this->city->goroda?>. Для получения более точной и детальной информации свяжитесь со специалистами фирм по указанным телефонным номерам.</p>
