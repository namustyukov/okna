	...
	<div class="content">
		<div class="content_index">
			...
			<div class="content_index_text">
				<p>Проект ОКНАОРГ.РУ собрал вместе все предприятия России, которые занимаются производством пластиковых, деревянных и алюминиевых окон, установкой окон ПВХ, остеклением балконов, установкой москитных сеток и жалюзи, ремонтом и производством фурнитуры для пластиковых окон.</p>
				<p>База данных насчитывает <?=$count_city?> городов России и ближнего зарубежья, а так же порядка <?=$count_company?> предприятий, связанных с производством пластиковых окон. Подобрать надежного производителя теперь будет просто и быстро. Для вас мы составили <a href="/<?=$this->city->simbol_name?>/company/list">рейтинг компаний</a>, базирующийся на отзывах клиентов, заявленной стоимости окон, предоставляемых услугах, наличию сертификатов ГОСТ, наличию акций и скидок, а также порядка 10 дополнительных показателей. Все показатели представлены на странице компании.</p>
				...
				<p>Это и многое другое в проекте ОКНАОРГ.РУ.</p>
			</div>
		</div>
	</div>
</div>