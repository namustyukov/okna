 ...
 * @since 1.0
 */
class CUploadedFileEx extends CComponent
{
	...
	protected static function collectFilesRecursive($key, $names, $tmp_names, $types, $sizes, $errors)
	{
		if(is_array($names))
		{
			...
			self::$_files[$key] = new CUploadedFileEx($names, $tmp_names, $types, $sizes, $errors);
	}
	...
	public function setName($filename){
		$this->_name = $filename . '.' . strtolower($this->getExtensionName());
	}
}
